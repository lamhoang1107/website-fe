                    ...
                    <div className="row g-4 align-items-center">
                        <div className="col-xl-4">
                            <div className="row gy-4 gx-0">
                                <div className="col-12 animated fadeInUp" data-animation="fadeInUp" data-delay="0.1s" style={{ animationDelay: "0.3s"  }}>
                                ...
                                <div className="col-12 animated fadeInUp" data-animation="fadeInUp" data-delay="0.3s" style={{ animationDelay: "0.3s"  }}>
                                    <div className="feature-item">
                                        <div className="feature-icon">
